...
// input parameter
run("Set Measurements...", "area centroid perimeter integrated area_fraction limit redirect=None decimal=5");
getdateandtime();
...
/*** FIXED HEADERS ***/
sum="Filename,Threshold,PunctaCount,Length,TotalArea,IntDen,RawIntDen,Puncta_per_10um,AvgSize,AvgInt_AU\n";
string="Filename,PunctaID,Area,Perim,X,Y,IntDen,RawIntDen\n";
/*********************/
...
function mask()	{
	...
	/*** FIXED ROW OUTPUT: includes X and Y, matches header ***/
